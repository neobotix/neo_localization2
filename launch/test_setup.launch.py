...
def generate_launch_description() -> LaunchDescription:
    ...
    bringup_dir = get_package_share_directory('neo_localization2')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'launch', 'test_setup.yaml'),
        description='Full path to the ROS2 parameters file to use for launch neo_localization2 node',
    )
